    ...
    device_rows <- do.call(
      ...
      lapply(indices, function(idx) {
        ...
        data.frame(
          ...
          gpu_utilization_pct = as.integer(metrics$gpu_utilization_pct),
          memory_utilization_pct = as.integer(metrics$memory_utilization_pct),
          ...
          memory_total_bytes = as.double(metrics$memory_total_bytes),
